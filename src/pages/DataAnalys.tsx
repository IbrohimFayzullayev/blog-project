    ...
    <div className="grid grid-cols-[4fr,1fr] gap-[10px] min-h-[500px]">
      <div className="bg-[#fff] p-3 640:p-5 text-black">
        ...
        <p className="content-text">
          ...
          communication, emotional connection, and collaboration. In the data,
          the casual, humorous exchanges (e.g., “Let me blow on your face my
          breath is so cure…”) reflect a high degree of emotional presence
          despite the digital setting. This suggests that the participants
          experience a sense of connection and intimacy through their
          communication, which is a core component of SPT
        </p>
        <p className="content-text">
          ...
          data, the participants demonstrate frequent interaction with one
          another through shared jokes, personal stories, and comments, which
          strengthens their social bonds. These frequent interactions contribute
          to the group’s cohesiveness, a key component of social presence.
        </p>
        <p className="content-text">
          ...
          collective sense of togetherness, even when they are physically
          distant.
        </p>
        <p className="content-text">
          ...
          the responses.The theory emphasizes the importance of emotional
          presence and social engagement, a sense of belonging, humor, and
          informality in online spaces, which are key components reflected. Most
          importantly, mutual support in this community helps to enhance
          learning.
        </p>

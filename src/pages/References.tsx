  ...
  return (
    <div className="text-black">
      ...
      <p className="mt-1 content-text">
        ...
        Education, 12(1), 8-22. <br /> • Gunawardena, C. N., & Zittle, F. J.
        (1997). Social presence as a predictor of satisfaction within a
        computer-mediated conferencing environment. American Journal of Distance
        Education, 11(3), 8-26.
        <br /> • Garrison, D. R., Anderson, T., & Archer, W. (2000). Critical
        ...
        <br /> • Vygotsky, L. S. (1978). Mind in Society: The Development of
        Higher Psychological Processes. Harvard University Press.
        <br /> • Dennen, V. P. (2008). Learning in online communities of
        practice. In M. S. Khine & I. M. Saleh (Eds.), New Science of Learning:
        Computers, Cognition, and Collaboration in Education (pp. 311-338).
        Springer.
        <br /> • Swan, K. (2002). Building learning communities in online
        courses: The importance of interaction. Education, Communication &

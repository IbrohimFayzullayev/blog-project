  ...
  return (
    <div className="text-black">
      ...
      <p className="mt-2 content-text">
        ...
        (English with Masters) where 9,816 members from different backgrounds
        joined to enhance their English. Nearly fifteen moderators control group
        interaction and follow community rules and restrictions. They organize
      ...
      <p className="mt-2 content-text">
        ...
        Semi-structured interviews were conducted to explore in depth the
        experiences of the participants in the community and insights regarding
        the role of social presence in their learning. Open-ended questions
        helped to focus on how they perceive the level of connection with other
        members and its impact on their learning motivation. As a sharing tool,
        the Telegram application functions allowed us to collect all the data:
        shared learning videos, discussion chats, voice recordings, and
        presentations posted by the community.The platform of Zoom was used to
      ...
      <p className="mt-2 content-text">
        ...
        banter).Manually coding and thematic content analyses were used to code
        and analyze the textual data and multimedia data, identify recurring
        themes, and map interactions within the community.
      </p>
    </div>
  );
};
